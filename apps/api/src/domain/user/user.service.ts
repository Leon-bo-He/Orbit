...
export interface IUserRepository {
  ...
  update(id: string, data: Partial<{ username: string; email: string; locale: string; timezone: string; avatar: string | null; notificationLeadTime: number }>): Promise<User | null>;
